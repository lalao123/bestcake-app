<template>
    ...
    <div class="content" v-if="detail">
      <div class="header clear"><h2><img src="/images/head.png" alt=""/></h2><p>{{detail.auth}}</p></div>
      <div class="cont">
        <h3>{{detail.title}}</h3>
...
<style scoped>
  ...
  .content{max-width:6.4rem; margin:0 auto; margin-top:0.6rem; background:#f2f4f5; padding-bottom:0.85rem;height:9.25rem;}
